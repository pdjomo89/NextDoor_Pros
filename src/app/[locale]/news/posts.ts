...
export const POSTS = ['p5', 'p4', 'p1', 'p2', 'p3'] as const;
...
export const POST_IMAGE: Record<PostId, string> = {
  // Our own logo, cropped into an app tile on a home screen (public/news/).
  p5: '/news/app-coming-soon.jpg',
...
export const POST_SLUG: Record<PostId, string> = {
  p5: 'nextdoor-pros-app-coming-soon',
