        ...
        <DashboardClient
          ...
          labels={{
            ...
            payments: {
              ...
              statusNotStartedTitle: t('payments.statusNotStartedTitle'),
              statusNotStartedBody: t('payments.statusNotStartedBody'),
              statusInProgressTitle: t('payments.statusInProgressTitle'),
              statusInProgressBody: t('payments.statusInProgressBody'),
              statusActiveTitle: t('payments.statusActiveTitle'),
              statusActiveBody: t('payments.statusActiveBody'),
              setupBtn: t('payments.setupBtn'),
              continueBtn: t('payments.continueBtn'),
              manageBtn: t('payments.manageBtn'),
              refreshBtn: t('payments.refreshBtn'),
              refreshing: t('payments.refreshing'),
              noContractor: t('payments.noContractor'),
              servicesTitle: t('payments.servicesTitle'),
              servicesIntro: t('payments.servicesIntro'),
              servicesEmpty: t('payments.servicesEmpty'),
              addService: t('payments.addService'),
              editService: t('payments.editService'),
              inactive: t('payments.inactive'),
              formNewTitle: t('payments.formNewTitle'),
              formEditTitle: t('payments.formEditTitle'),
              fieldTitle: t('payments.fieldTitle'),
              fieldDescription: t('payments.fieldDescription'),
              fieldPrice: t('payments.fieldPrice'),
              priceHint: t('payments.priceHint'),
              fieldActive: t('payments.fieldActive'),
            ...
            bookings: {
              ...
              statusHeld: t('bookings.statusHeld'),
              statusDelivered: t('bookings.statusDelivered'),
              statusReleasing: t('bookings.statusReleasing'),
              statusReleased: t('bookings.statusReleased'),
              statusRefunded: t('bookings.statusRefunded'),
              statusDisputed: t('bookings.statusDisputed'),
              markDelivered: t('bookings.markDelivered'),
              markingDelivered: t('bookings.markingDelivered'),
              deliveredHint: t('bookings.deliveredHint'),
              payoutLabel: t('bookings.payoutLabel'),
              releasedOn: t('bookings.releasedOn'),
              error: t('bookings.error'),
            },
            membership: {
