        ...
        <DashboardClient
          ...
          labels={{
            ...
            services: {
              ...
              servicesEmpty: t('services.servicesEmpty'),
              addService: t('services.addService'),
              editService: t('services.editService'),
              inactive: t('services.inactive'),
              formNewTitle: t('services.formNewTitle'),
              formEditTitle: t('services.formEditTitle'),
              fieldTitle: t('services.fieldTitle'),
              fieldDescription: t('services.fieldDescription'),
              fieldPrice: t('services.fieldPrice'),
              priceHint: t('services.priceHint'),
              fieldActive: t('services.fieldActive'),
              save: t('services.save'),
              saving: t('services.saving'),
              cancel: t('services.cancel'),
              remove: t('services.remove'),
              removeConfirm: t('services.removeConfirm'),
              saveError: t('services.saveError'),
            },
          }}
        />
      </div>
